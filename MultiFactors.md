...
![](https://mmbiz.qpic.cn/mmbiz_png/iaHVEbyZpr5ec7nk3aiaBfA2fxwrs7bCSOU7WlDxr7j0eibh4BKTk0Gt8l2icTm9D3gcrPyONIUib52N5RI4kfpLx9g/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1)
...
在Ricequant平台可以通过get_fundamentals拿到股票的财务数据，目前的提供的财务数据可以在财务数据文档中找到相应字段。我们的财务数据来源于国内最好的金融数据供应商之一的恒生聚源，从而极好地保证了策略输出结果的准确性。
...
1.2 & 1.3的详细方法介绍和相关代码可见帖子[《数据预处理（上）之离群值处理、标准化》](http://mp.weixin.qq.com/s?__biz=MzA4NTMyOTU3Ng==&mid=2649582447&idx=1&sn=0f1746eb53b4741665bc3fd7bd75c853&chksm=87c058a8b0b7d1be6350b4dff9e0253facc96019953b9c1d423d52000fe59312a44a4346ebb4&scene=21#wechat_redirect)。

![](https://mmbiz.qpic.cn/mmbiz_png/iaHVEbyZpr5ec7nk3aiaBfA2fxwrs7bCSOehIenibTtwHLCtgkVjoYSQxaYa6nJNxiaKa2AjyIAzf1jYKGnGM2D2GQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1)
...
我们在最开始采集数据时所初步构建的因子池，**在逻辑上与收益率是有着一定经济意义上的联系**，接下来我们需要对它们进行实证分析，筛选掉与收益率相关性不高的因子，从而得到真正有效的因子池。此部分可见帖子[《波动率因子分析》](http://mp.weixin.qq.com/s?__biz=MzA4NTMyOTU3Ng==&mid=2649582411&idx=1&sn=4a03bc7954b74ed31eb9256fd198ffbe&chksm=87c0588cb0b7d19ad7cf9503dd20ce9ded4cffce36627fd941c73b7dad3bf27ad5b48fbef224&scene=21#wechat_redirect)。
...
实际上中性化的含义不止对因子的中性化，详细和下文相关代码可以见[《数据预处理（下）之中性化》](http://mp.weixin.qq.com/s?__biz=MzA4NTMyOTU3Ng==&mid=2649582511&idx=1&sn=a8428fa9591a43d9632d5f9c97d2157a&chksm=87c05868b0b7d17e42053bc400158d895ed2104b3437cd128f407a68b995ff4a23ba3fb834ad&scene=21#wechat_redirect)
...
![](https://mmbiz.qpic.cn/mmbiz_png/iaHVEbyZpr5ec7nk3aiaBfA2fxwrs7bCSOCXKQPQDiaZoMglTicicThWpHWGtaKvNs47vbgVU3da7ljvqtq6DDibqUYw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1)
...
此部分内容可见帖子[《多因子权重优化方法比较》](http://mp.weixin.qq.com/s?__biz=MzA4NTMyOTU3Ng==&mid=2649582534&idx=1&sn=908e73f0acbe32dc4e781cab9de6fab7&chksm=87c05801b0b7d117cf00be11a8e9d990d3478eea0c2701b88abd598c7d42e9a22b8e81fdbdb0&scene=21#wechat_redirect)
...
经过一系列的筛选和分析后，现在已经得到最终的因子集。本篇在此部分以打分法为例，回归法的步骤将在之后的文章更新。在打分法中，我们将赋予各因子权重，以期符合选股预期或经济逻辑。此部分可参考[《多因子权重优化方法比较》](http://mp.weixin.qq.com/s?__biz=MzA4NTMyOTU3Ng==&mid=2649582534&idx=1&sn=908e73f0acbe32dc4e781cab9de6fab7&chksm=87c05801b0b7d117cf00be11a8e9d990d3478eea0c2701b88abd598c7d42e9a22b8e81fdbdb0&scene=21#wechat_redirect)。
